...
AFRAME.registerComponent('rotate-on-enter-ar', {
  init: function () {
    var Object = this.el.sceneEl.object3D;
    var self = this;
    this.el.sceneEl.addEventListener('enter-vr', function () {
      ...
      if (self.el.sceneEl.is('ar-mode')) {
         document.getElementById("pivot").setAttribute('rotation', new THREE.Vector3(0, 0, Math.PI / 2));
